    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                limit_choices_to={"cargo": "Jefe de Cuadrilla"},
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="cuadrillas_dirigidas",
                to="cuadrillas.miembro_cuadrilla",
                unique=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="cuadrillas",
                through="cuadrillas.Miembro_cuadrilla",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="id_cuadrilla",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="registros_de_cierre",
                        to="cuadrillas.cuadrilla",
                    ),
                ),
            ],
